...
function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="flex flex-col overflow-hidden group hover:shadow-lg transition-all duration-300 border-border hover:border-primary/20 py-0">
      {image?.url && (
...
export function Projects({ projects }: ProjectsProps) {
  ...
  const hasMultipleProjects = sortedProjects.length > 1;
