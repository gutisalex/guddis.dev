/** biome-ignore-all lint/a11y/useSemanticElements: Carousel uses div elements for layout structure, semantic elements are handled via ARIA attributes */
"use client";
...
function CarouselDots({ className, ...props }: React.ComponentProps<"div">) {
  ...
  React.useEffect(() => {
    ...
    const updateSlides = () => {
      ...
      setSlides(Array.from({ length: slideCount }, (_, i) => i));
    };
